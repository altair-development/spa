...
import { AuthSliceStateType, ClansSliceStateType, ProjectsSliceStateType, ErrorsSliceStateType, HashParamsSliceStateType } from 'SliceStateTypes'
...
import { defaultinitialState as defaultHashParamsState, setHashParams } from '../../../../redux/hashParams/slice'
import { defaultinitialState as defaultMembersState } from '../../../../redux/members/slice'
import { getDecorator } from '../CreateProjectDlg/default.stories'
...
import { randomStrOfAlphanumeric } from '../../../../utils'
...
export default {
  title: 'components/organisms/Sidebar/default',
  component: Sidebar,
  parameters: {
    msw: {
      handlers: {
...
const Template1: ComponentStory<typeof Sidebar> = () => {
  return (
    <Wrapper>
      <Sidebar
        style={{
...
Pt001.parameters = {
  msw: {
    handlers: {
      'clans/create': rest.post('http://localhost:3000/api/clans/create', async (req, res, ctx) => {
        const body = await req.json()
        const clan = {
          id: randomStrOfAlphanumeric(24),
          name: body.name,
          user_id: '',
          user_name: '',
          created: '',
